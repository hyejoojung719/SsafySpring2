...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.car.model..Car*.*(..))")
	...
	@Around(value = "execution(* com.ssafy.car.model..Car*.*(..))")
	...
	@AfterReturning(value = "execution(* com.ssafy.car.model..Car*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.car.model..Car*.list*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.car.model..Car*.list*(..))")
