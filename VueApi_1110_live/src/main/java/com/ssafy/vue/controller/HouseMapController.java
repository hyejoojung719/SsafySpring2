...
public class HouseMapController {
	...
	public ResponseEntity<String> aptList(@PathVariable("lawd_cd") String lawdCd, @PathVariable("deal_ymd") String dealYmd) throws IOException {
		logger.info("sido - 호출");
		String serviceKey = "y0ayfn9wPs8%2F7lb3i7TPUDZNfV0h0SpKCnq0I6P%2Bw6%2FZ%2BdmGDlLUNRby9pJI329Qewj0q8NZvFcCtYTepHIh4g%3D%3D";
		...
		rd.close();
		conn.disconnect();
		System.out.println(sb.toString());	// xml을 준다.
